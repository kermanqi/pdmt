...
for itime=1:nt
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 模型损伤计算
    [damage,damage_particle,max_s0]=function_damage_solution(dimension,particle,size_particle,horizon_particle,size_horizon_particle,global_displacement_vector,damage_particle,sc,itime,output_interval,size_particle_damage,particle_damage);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
% 结果可视化
