function[damage,damage_particle,max_s0]=function_damage_solution(dimension,particle,size_particle,horizon_particle,size_horizon_particle,global_displacement_vector,damage_particle,sc,itime,output_interval)
