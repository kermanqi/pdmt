function[global_heat_conduction_matrix]=function_global_heat_conduction_matrix(particle,size_particle,horizon_particle,size_horizon_particle,c0,volume_particle,dimension)
    ...
    for i=1:size_particle                       % 对粒子循环
        ...
        for j=1:size_horizon_particle           % 对第i个粒子域内的粒子进行循环
            ...
            if jj>0                             % 如果第i个粒子域内的第j个粒子存在，则执行条件语句中的内容
                ...
                kk_PD=c0/length_i_jj*[1 -1;-1 1]*volume_particle*volume_particle; % 粒子i与粒子j组成键的热传导矩阵
