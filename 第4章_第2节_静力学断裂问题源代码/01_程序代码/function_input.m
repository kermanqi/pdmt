function[E0,dimension,dettx,m,length_x,length_y,length_z,xx_min,yy_min,zz_min,xx_max,yy_max,zz_max,detla,c0,volume_particle,size_horizon_particle, ...
    ...
    uniform_load_top,uniform_load_behind,uniform_load_front,body_force,det_displacement_left,det_displacement_right,det_displacement_bottom,det_displacement_top,det_displacement_behind, ...
    ...
    initial_crack,xx1_crack,yy1_crack,zz1_crack,xx2_crack,yy2_crack,zz2_crack,sc,nt,output_interval]=function_input()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                                                             
% 需输入的模型参数
E0=210000;          % 弹性模量
...
displacement_left=[-0.088,0,0];      % 左边界
displacement_right=[0.088,0,0];      % 右边界
