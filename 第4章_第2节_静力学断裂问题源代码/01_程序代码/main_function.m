...
for itime=1:nt
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 总体刚度矩阵
    global_stiffness_matrix=function_global_stiffness_matrix(particle,size_particle,horizon_particle,size_horizon_particle,c0,volume_particle,dimension,damage_particle);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %施加边界条件并进行静力学求解                                             
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 模型损伤计算
    [damage,max_s0,damage_particle]=function_damage_solution(dimension,particle,size_particle,horizon_particle,size_horizon_particle,global_displacement_vector,damage_particle,sc,itime,output_interval,size_particle_damage,particle_damage);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
% 结果可视化
