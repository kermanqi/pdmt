...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 总体热传导矩阵
global_heat_conduction_matrix=function_global_heat_conduction_matrix(particle,size_particle,horizon_particle,size_horizon_particle,c0_temperature,volume_particle,dimension);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 施加边界条件并进行稳态热传导求解                                             
[global_temperature_vector]=function_temperature_solution(dimension,size_particle,global_heat_conduction_matrix,size_temperature_boundary_left,particle_boundary_left_temperature, ...
